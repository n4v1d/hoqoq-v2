                    ...
                    <div class="card-body ">
                        ...
                        <div class="row" style="margin-top: 30px">
                            ...
                            <div class="col-lg-2">
                                ...
                                <input type="text"    name="bimeTakmili_count" id="" class="form-control input-lg" value="0" >
                            </div>

                            <div class="col-lg-3">
                                <label>   شماره بیمه</label>
                                <input type="text" name="sso" id="" class="form-control input-lg" value="0" >
                            </div>


                            <div class="col-lg-3">
                                <label> سمت </label>
                                <input type="text" name="sso_type" id="" class="form-control input-lg" value="0" >
                            </div>
                        ...
                        <div class="row" style="margin-top: 30px">
                            <div class="col-lg-2">
                                <label>نام پدر</label>
                                <input type="text" name="father" id="" class="form-control input-lg" value="0" >
                            </div>
                            ...
                            <div class="col-lg-2">
                                ...
                                <select name="education" id="" class="form-control input-lg">
                                    <option value="1">کمتر از دیپلم</option>
                            ...
                            <div class="col-lg-2">
                                <label> کد ملی </label>
                                <input type="text" name="national_id" id="" class="form-control input-lg" value="0" >
                            </div>

                            <div class="col-lg-2">
                                <label> تاریخ تولد (1370/01/01)  </label>
                                <input type="text" name="bday" id="" class="form-control input-lg" value="0" >
                            </div>
                            <div class="col-lg-2">
                                <label> صادره  </label>
                                <input type="text" name="from" id="" class="form-control input-lg" value="0" >
                            </div>
